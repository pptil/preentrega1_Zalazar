...
class ProductManager {
    ...
    validar(productFields) {
        ...
        if (!price || typeof price !== 'string') throw new Error('El precio es requerido y debe ser numérico');
        if (!stock || typeof stock !== 'string') throw new Error('Stock es requerido y debe ser un numérico');
